...
- (IBAction)insertData{
    ...
    student.name = @"张三2";
    student.faceImage = [UIImage imageNamed:@"mj"];
    student.id = @(11);
    ...
    student2.name = @"李四2";
    student2.faceImage = [UIImage imageNamed:@"mj"];
    student2.id = @(23);
    ...
    //====== 2'
    //        // 从托管对象上下文中获取BookData名对应的Entity对象
    //        NSEntityDescription *entityDescription = [NSEntityDescription entityForName:@"BookData" inManagedObjectContext:self.managedContext];
    //        Student *stu = [[Student alloc] initWithEntity:entityDescription insertIntoManagedObjectContext:self.managedContext];
    //
    //        // 设置要保存的数据
    //        Book *book = [[Book alloc] init];
    //        NSDictionary *dic = @{@"name": self.name_textField.text,
    ...
    //
    ////    student.booksArray = [NSKeyedArchiver archivedDataWithRootObject:@[book,book1]];
    //    student.booksArray = [NSKeyedArchiver archivedDataWithRootObject:@[book]];
    //
    //
    //    //第二组数据
    //    Student *student2 = [NSEntityDescription insertNewObjectForEntityForName:@"Student" inManagedObjectContext:self.managedContext];
    ...
    //
    ////    student2.booksArray = [NSKeyedArchiver archivedDataWithRootObject:@[book2,book22]];
    //    student2.booksArray = [NSKeyedArchiver archivedDataWithRootObject:@[book2]];
...
- (IBAction)readData{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        for (Student *stu in objs) {
            ...
            UIImageView *iconView = [[UIImageView alloc] initWithFrame:CGRectMake(index*40, [UIScreen mainScreen].bounds.size.height - 50 , 40, 40)];
            iconView.image = stu.faceImage;
